...
from Metaplex.metaplex.transactions import deploy,topup,mint,send,burn,update_metadata_instruction
...
class MetaplexAPI():
    ...
    def topup(self, api_endpoint, to, amount=None, max_retries=3, skip_confirmation=True, max_timeout=60, target=20,
              finalized=True):
        """
    ...
    def mint(self, api_endpoint, contract_key, dest_key, link, max_retries=3, skip_confirmation=True, max_timeout=60, target=20, finalized=True, supply=1):
        """
